	...
	try(Connection conn = DbConnection.getConnection()){
		...
		try {
			...
			if(Objects.nonNull(project)) {
				...
				project.getCategories().addAll(fetchCategoriessForProject(conn, projectId));
			}
...
private List<Category> fetchCategoriessForProject(Connection conn, Integer projectId) throws SQLException {
