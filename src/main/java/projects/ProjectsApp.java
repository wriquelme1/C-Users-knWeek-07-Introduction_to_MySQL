...
//@formatter:off
 private List<String> operation = List.of("1) Add a project");
 // @formatter:on
 ...
 * @throws DbException thrown if an error occurs convertong the number to a BigDecimal.
 * */
...
private void printOperations() {
	...
	operation.forEach(line -> System.out.println("  " + line));
}
}
